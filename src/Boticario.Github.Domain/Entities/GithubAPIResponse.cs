...
{
    public partial class GithubAPIResponse
    {
        [JsonProperty("items")]
    ...
    public partial class GithubAPIResponse
    {
        public static GithubAPIResponse FromJson(string json) => JsonConvert.DeserializeObject<GithubAPIResponse>(json);
    }

    public static class Serialize
    {
        public static string ToJson(this GithubAPIResponse self) => JsonConvert.SerializeObject(self);
    }
